defmodule Naturecounts.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      # Membrane media pipeline
      {:membrane_core, "~> 1.2"},
      {:membrane_file_plugin, "~> 0.17"},
      {:membrane_mp4_plugin, "~> 0.36"},
      # membrane_h264_plugin not needed — membrane_h26x_plugin (via webrtc) provides Membrane.H264.Parser
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind naturecounts", "esbuild naturecounts"],
      "assets.deploy": [
        "tailwind naturecounts --minify",
        "esbuild naturecounts --minify",
        "phx.digest"
      ],
